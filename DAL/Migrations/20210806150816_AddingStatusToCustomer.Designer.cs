...
namespace Allprimetech.DAL.Migrations
{
    ...
    [Migration("20210806150816_AddingStatusToCustomer")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.ApplicationUserCustomer", b =>
                {
                    b.Property<int>("ApplicationUserCustomerID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("ApplicationUserCustomerID");

                    b.HasIndex("ApplicationUserID");

                    b.HasIndex("CustomerID");

                    b.ToTable("ApplicationUserCustomers");
                });
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.Customer", b =>
                {
                    ...
                    b.Property<int>("_CustomerStatus")
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.CylinderGroup", b =>
                {
                    b.Property<int>("CylinderGroupID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.CylinderGroupVerification", b =>
                {
                    b.Property<int>("CylinderGroupVerificationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("CylinderGroupVerificationID");
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.GroupInfoVerification", b =>
                {
                    b.Property<int>("GroupInfoVerificationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.HasKey("GroupInfoVerificationID");

                    b.HasIndex("CustomerID");

                    b.HasIndex("GroupID");

                    b.ToTable("GroupInfoVerifications");
                });
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.OrderAvailable", b =>
                {
                    b.Property<int>("OrderAvailableID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.OrderValidation", b =>
                {
                    b.Property<int>("OrderValidationID")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<DateTime>("_DateValidated")
                        .HasColumnType("datetime(6)");

                    b.HasKey("OrderValidationID");
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.OrderValidation", b =>
                {
                    ...
                    b.HasOne("Allprimetech.Interfaces.Models.Order", "Order")
                        .WithMany("_OrderValidations")
                        .HasForeignKey("OrderID")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Allprimetech.Interfaces.Models.ApplicationUser", "ValidatedBy")
                        .WithMany()
