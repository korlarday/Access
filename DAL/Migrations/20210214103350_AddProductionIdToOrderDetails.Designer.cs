...
namespace Allprimetech.DAL.Migrations
{
    ...
    [Migration("20210214103350_AddProductionIdToOrderDetails")]
    partial class AddProductionIdToOrderDetails
    {
            ...
            modelBuilder.Entity("Allprimetech.Interfaces.Models.OrderDetail", b =>
                {
                    ...
                    b.HasOne("Allprimetech.Interfaces.Models.Production", "Production")
                        .WithMany()
